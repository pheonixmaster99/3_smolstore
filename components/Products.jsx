...
export default function Products(props) {
    ...
    return (
        <>
            ...
            {portalImage && (  // conditional rendering within NextJS. If portalImage truthy value is null, no children within Portal container are rendered. If portalImage truthy value is true, the children within Portal container are rendered.
